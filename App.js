...
export default function App() {
  ...
  const [lista, setLista] = useState([
    {
        title:"PlayStation",
        text: "Controlado por movimentos · PlayStation Now · PlayStation Network",
        release: R$ 15000,
        img: 'https://http2.mlstatic.com/playstation-3-ps3-slim-72-jogos-completos-D_NQ_NP_943471-MLB42135922367_062020-F.webp'
    },
        ...
        <View style={{...StyleSheet.absoluteFill, backgroundColor: '#000'}}>  
          ...
          >
            ...
            <View style={styles.moreInfo}>
              ...
              onPress={() => alert('Mercado aqui - Veja os detalhes no link')}
              >
                <Icon 
                name="queue" 
                color="#131313" 
